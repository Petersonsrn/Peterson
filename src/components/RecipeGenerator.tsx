...
export const RecipeGenerator: React.FC<RecipeGeneratorProps> = ({ generateRecipe, isGenerating }) => {
  ...
  return (
    <motion.section
      ...
      className="w-full max-w-3xl mx-auto bg-white p-10 md:p-12 rounded-3xl shadow-xl"
        ...
        <div className="relative">
          ...
          <div className="relative">
            <input
              ...
              className="w-full pl-4 pr-10 py-4 text-lg bg-white text-gray-900 placeholder-gray-400 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-amber-500"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-4 text-lg border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-amber-500 bg-white text-gray-700 font-semibold"
            >
